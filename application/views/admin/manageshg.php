    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="row"> 
              	<div class="col-md-12">
                	<div id="manageshg_table" class="tile-body"></div>
                </div>
            </div>
          </div>
        </div>
    ...
    function loadManageshg()
    { 
      var url = "<?php echo site_url('index.php/data_controller/loadManageshg'); ?>"; 
      StartInsideLoading();
      $.ajax({
        type: "post",
        url: url,
        ...
        try{  
          if (response.success)
             { 
            $('#manageshg_table').html(response.html);
              $('#manageshg').DataTable();
