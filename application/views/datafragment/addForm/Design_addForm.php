              ...
              <form class="row" id="MasDesignForms">
                <div class="form-group col-md-4 align-self-end">
                  ...
                  <input name="design_title" style="margin-top: 10px;"
    				class="form-control" type="text" id="design_title"
				 ...
				 <div class="form-group col-md-4 align-self-end">
                  ...
                  <textarea name="design_description" style="margin-top: 10px;"
    				class="form-control" type="text" id="design_description"
    				placeholder="Description"></textarea>
                </div>
               
                
                <div class="form-group col-md-4 align-self-end">
                  <button onclick="addDesign()" class="btn btn-primary" type="button"><i class="fa fa-fw fa-lg fa-check-circle"></i>Submit</button>
                  &nbsp;&nbsp;&nbsp;
                  <a class="btn btn-secondary" href="#" onclick="resetAllFormValue('#MasDesignForms')"><i class="fa fa-fw fa-lg fa-times-circle"></i>Reset</a>
                &nbsp;&nbsp;&nbsp;
