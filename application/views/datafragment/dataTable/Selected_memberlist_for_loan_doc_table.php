        ...
        <?php $count = 1; foreach ( $result as $mem_data) { ?>
            <tr>
                ...
                <td>
					...
					<button class="btn btn-sm btn-success" onclick="AddGroupLoanDocUploadForm('<?php echo $mem_data['Loan_acc_no']?>','<?php echo $mem_data['Loan_master_id']?>')" type="button" >Upload Document</button>					
    			</td>
				</tr>
        <?php $count ++;  } ?>
        </tbody>
